...
public class EmployeeTest {
	...
	public void setUp() throws Exception {
		...
		e1 = new Employee("Avenger", "NR", 5,19,"NONE",12345,1);
		//seen 0 movies this month
		e2 = new Employee("The walking dead", "NR", 2,12,"NONE",23456,0);
		//seen 1 movies this month
		e3 = new Employee("Arrow", "PG13", 3,20,"IMAX",34567,1);
		//seen 2 movies
		e4 = new Employee("Book Club", "PG13", 1,13,"3D",45678,2);
		//seen 0 movies this month
		e5 = new Employee("Life of the Party", "PG13", 3,21,"3D",56789,0);
		//seen 3 movies this month
		e6 = new Employee("Lucy", "PG13", 2,14,"3D",67890,2);
	}
